      ...
      <el-card class="profile-card">
          ...
          <el-form :model="userForm" label-width="120px">
              ...
              <div class="avatar-upload-section">
                ...
                >
                  <div class="avatar-preview">
                    <img v-if="userForm.avatar" :src="getAvatarUrl(userForm.avatar)" class="avatar-image" />
            ...
            <el-form-item label="邮箱">
              <el-input 
                ...
                type="email"
              />
              <div class="field-hint">用于接收系统通知</div>
            </el-form-item>
        ...
        <div v-else class="info-display">
          ...
          <div class="info-row">
            ...
            <div class="info-value">{{ formatDate(userStore.user?.createdAt || userStore.user?.createTime) }}</div>
          </div>
          <div class="info-row" v-if="userStore.user?.bio">
            <div class="info-label">个人简介：</div>
            <div class="info-value">{{ userStore.user?.bio }}</div>
          </div>
        </div>
      </el-card>
      ...
      <el-card class="profile-card" style="margin-top: 20px;">
        ...
        <el-form :model="settingsForm" label-width="120px">
          ...
          <el-form-item label="通知设置">
            <el-switch v-model="settingsForm.emailNotification" active-text="邮件通知" />
            <el-switch v-model="settingsForm.smsNotification" active-text="短信通知" style="margin-left: 20px;" />
          </el-form-item>
          <el-form-item>
...
const saveSettings = async () => {
  try {
    // 账户设置（通知设置）暂时保存到本地存储
    // 如果后端有对应的API，可以在这里调用
    localStorage.setItem('adminSettings', JSON.stringify(settingsForm.value))
